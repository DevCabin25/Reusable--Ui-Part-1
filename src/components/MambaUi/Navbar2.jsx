...
const Navbar2 = () => {
	...
	<div className="container flex justify-between h-16 mx-auto">
		<ul className="items-stretch hidden space-x-3 lg:flex">
			<li className="flex">
				<a rel="noopener noreferrer" href="#" className="flex items-center px-4 -mb-1 border-b-2 border-violet-600 text-violet-600">Link</a>
			</li>
			<li className="flex">
		...
		<div className="flex items-center md:space-x-4">
			<div className="relative">
				...
				<input type="search" name="Search" placeholder="Search..." className="w-32 py-2 pl-10 text-sm rounded-md sm:w-auto focus:outline-none bg-gray-100 text-gray-800 focus:bg-gray-50" autoComplete="off" />
			</div>
